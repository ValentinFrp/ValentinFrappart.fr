          ...
          <div className="bg-slate-800 rounded-lg p-8 shadow-xl">
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-6">
                Passionné par le développement web depuis 2 ans, je crée des
                applications web modernes et performantes. Mon approche combine
                créativité et rigueur technique pour délivrer des solutions qui
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Immédiate</p>
                  </div>
                </div>
              </div>
